...
import sys
ARENA_LOOK = {
    "frostbite": (1, "1.22", "0.38", "0.72", "0"),
    "ironman": (0, "1.10", "0.28", "0.80", "0"),
    "ghost_protocol": (1, "1.45", "0.58", "0.50", "0"),
    "overgrowth": (1, "1.32", "0.44", "0.66", "0"),
    "bleed_chamber": (1, "1.50", "0.60", "0.48", "0"),
}
LOOK = {
    "oa_shine": (1, "1.40", "0.50", "0.60", "0"),
    "oa_minia": (1, "1.40", "0.48", "0.62", "0"),
    "oa_rpg3dm2": (1, "1.40", "0.50", "0.60", "0"),
    "slimefac": (1, "1.45", "0.55", "0.55", "0"),
    "oa_dm1": (1, "1.42", "0.52", "0.58", "0"),
    "oa_dm3": (0, "1.25", "0.40", "0.70", "0"),
    "islanddm": (0, "1.20", "0.35", "0.72", "0"),
    "oa_dm6": (1, "1.40", "0.50", "0.60", "0"),
    "suspended": (1, "1.38", "0.48", "0.62", "0"),
    "am_underworks": (1, "1.45", "0.55", "0.55", "0"),
    "hydronex": (1, "1.42", "0.52", "0.58", "0"),
    "am_galmevish": (1, "1.40", "0.48", "0.62", "0"),
    "oa_thor": (1, "1.40", "0.50", "0.60", "0"),
}
